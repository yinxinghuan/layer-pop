...
- 游戏：Layer Pop
- 类型：action
- 简述：Pop your fun — 1000 层霓虹圈嵌套，拖拽对齐缺口让小球穿透，连过 3 关进入 FEVER MODE，玻璃碎裂的爽片
- 框架 / 语言 / 构建：TypeScript, Vite
- 渲染方式：Canvas/WebGL
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Layer Pop；cover_url=/poster.png；category=action；uuid=d8d3b9bf-05a7-420a-b441-6b3357020d02
